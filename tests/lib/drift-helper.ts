...
export async function mockOracle(
    ...
    const pyth_idl = JSON.parse(a);
    const provider = anchor.AnchorProvider.env()
	const program = new Program(pyth_idl, new PublicKey("E6HjiqKytNxovAKfbudZcV72iryoFzP6nL71zM6A4sp5"), provider);
